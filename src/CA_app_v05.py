...
if __name__ == "__main__":
    ...
    user_initial_condition = input("What initial conditions should be applied? [max3min0]\t") or "max3min0"
    user_dimensions = tuple(int(a) for a in (input("What dimensions should be used? [20,20]\t\t\t") or "20,20").split(","))
